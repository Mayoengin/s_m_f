        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="d-flex flex-column align-items-center text-center mb-3">
              <div class="user-avatar user-avatar-lg bg-primary text-white rounded-circle mb-2">
                {{ userInitial }}
              </div>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center mb-3">
              <div class="user-avatar user-avatar-sm bg-primary text-white rounded-circle me-2">
                {{ userInitial }}
              </div>
              <router-link 
                to="/create-post" 
          ...
          <div class="card-body">
            ...
            <div v-else>
              <div v-for="user in suggestedUsers" :key="user.id" class="d-flex align-items-center mb-3">
                <div class="user-avatar user-avatar-sm bg-secondary text-white rounded-circle me-2">
